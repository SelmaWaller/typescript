    ...
    <div class="my-6">
      ...
      <div class="pb-10">
        <div class="pb-6">
          ...
          <div class="bg-gray-700 rounded p-4 mb-6 font-mono">
            ...
            <p><span class="pr-6 text-slate-400">2</span>&nbsp;</p>
            <p class="text-slate-50 indent">
              <span class="pr-6 text-slate-400">3</span>things.push({id: 1,
              name: 'Mario'})
            </p>
          </div>
      ...
      <div class="pb-10">
        <div class="pb-6">
          ...
          <div class="bg-gray-700 rounded p-4 mb-6 font-mono">
            <p class="text-slate-50 indent">
              <span class="pr-6 text-slate-400">1</span>let hsla: [number,
      ...
      <div class="pb-10">
        <div class="pb-6">
          <h3 class="text-2xl mb-2 text-slate-800" id="interfaces">
            Interfaces
          </h3>
          <ul class="pb-5 text-slate-900">
            <li>
              - An object has to match the structure of its interface type
            </li>
            <li>
            ...
            <li>
              - Interfaces that extends other interfaces inherits their
              properties
            </li>
            <li>
          ...
          <div class="bg-gray-700 rounded p-4 mb-6 font-mono">
            ...
            <p class="text-slate-50 indent">
              ...
              title: 'First post', body: 'Something interesting', tags:
              ['gaming', 'tech'], created_at: new Date(), author: authorOne }
            </p>
          </div>
          ...
          <div class="bg-gray-700 rounded p-4 mb-6 font-mono">
            <p class="text-slate-50 indent">
              <span class="pr-6 text-slate-400">1</span>function
              createPost(post: Post): void { console.log(`Created
              ${post.created_at} by ${post.author.name}`) }
            </p>
            <p><span class="pr-6 text-slate-400">2</span>&nbsp;</p>
            <p class="text-slate-50 indent">
          ...
          <div class="bg-gray-700 rounded p-4 mb-6 font-mono">
            ...
            <p><span class="pr-6 text-slate-400">3</span>&nbsp;</p>
            <p class="text-slate-50 indent">
              <span class="pr-6 text-slate-400">4</span>posts.push({ title:
              'First post', body: 'Something interesting', tags: ['gaming',
      ...
      <div class="pb-10">
        <div class="pb-6">
          ...
          <div class="bg-gray-700 rounded p-4 mb-6 font-mono">
            <p class="text-slate-50 indent">
              <span class="pr-6 text-slate-400">1</span>type Calculator =
              (numOne: number, numTwo: number) =>
            </p>
            <p><span class="pr-6 text-slate-400">2</span>&nbsp;</p>
            <p class="text-slate-50 indent">
              <span class="pr-6 text-slate-400">3</span>function
            ...
            <p class="text-slate-50 indent">
              <span class="pr-6 text-slate-400">13</span
          ...
          <div class="bg-gray-700 rounded p-4 mb-6 font-mono">
            <p class="text-slate-50 indent">
              <span class="pr-6 text-slate-400">1</span>interface HasArea {
              name: string calcArea: (a: number) => number }
              <span class="pl-2 text-green-400 italic"
      ...
      <div class="pb-10">
        <div class="pb-6">
          ...
          <div class="bg-gray-700 rounded p-4 mb-6 font-mono">
            ...
            <p class="text-slate-50 indent">
              <span class="pr-6 text-slate-400">3</span>function
              getRandomColor(): Rgb { const r = Math.floor(Math.random() * 255)
              const g = Math.floor(Math.random() * 255) const b =
              Math.floor(Math.random() * 255) return [r, g, b] }
            </p>
            <p><span class="pr-6 text-slate-400">4</span>&nbsp;</p>
            <p class="text-slate-50 indent">
          ...
          <div class="bg-gray-700 rounded p-4 mb-6 font-mono">
            <p class="text-slate-50 indent">
              <span class="pr-6 text-slate-400">1</span>type User = { name:
              string score: number }
            </p>
            <p><span class="pr-6 text-slate-400">2</span>&nbsp;</p>
            <p class="text-slate-50 indent">
          ...
          <div class="bg-gray-700 rounded p-4 mb-6 font-mono">
            <p class="text-slate-50 indent">
              <span class="pr-6 text-slate-400">1</span>type Person = { id:
              string | number; firstName: string; };
            </p>
            <p><span class="pr-6 text-slate-400">2</span>&nbsp;</p>
            <p class="text-slate-50 indent">
      ...
      <div class="pb-10">
        <div class="pb-6">
          ...
          <div class="bg-gray-700 rounded p-4 mb-6 font-mono">
            ...
            <p><span class="pr-6 text-slate-400">2</span>&nbsp;</p>
            <p class="text-slate-50 indent">
              <span class="pr-6 text-slate-400">3</span>type Id = number |
              string
            </p>
            <p class="text-slate-50 indent">
            ...
            <p><span class="pr-6 text-slate-400">5</span>&nbsp;</p>
            <p class="text-slate-50 indent">
              <span class="pr-6 text-slate-400">6</span>anotherId =
              '2=|[fSJEFI?'
            </p>
            <p class="text-slate-50 indent">
      ...
      <div class="pb-10">
        <div class="pb-6">
          ...
          <div class="bg-gray-700 rounded p-4 mb-6 font-mono">
            <p class="text-slate-50 indent">
              <span class="pr-6 text-slate-400">1</span>type Id = number |
              string
            </p>
            <p><span class="pr-6 text-slate-400">2</span>&nbsp;</p>
            <p class="text-slate-50 indent">
            ...
            <p><span class="pr-6 text-slate-400">8</span>&nbsp;</p>
            <p class="text-slate-50 indent">
              <span class="pr-6 text-slate-400">9</span>console.log(idOne,
              idTwo)
          ...
          <div class="bg-gray-700 rounded p-4 mb-6 font-mono">
            ...
            <p><span class="pr-6 text-slate-400">3</span>&nbsp;</p>
            <p class="text-slate-50 indent">
              <span class="pr-6 text-slate-400">4</span>function
              logDetails(value: User | Person): void { if(value.type) === 'user'
      ...
      <div class="pb-10">
        <div class="pb-6">
          ...
          <ul class="mb-6 text-slate-900">
            ...
            <li>
              - Typescript classes allows us to create new class objects,
              whereas an interface does not
            </li>
      ...
      <div class="pb-10">
        <div class="pb-6">
          ...
          <ul class="mb-6 text-slate-900">
            <li>
              - A way to make generic, reusable structures by passing in the
              data types themselves into those structures
            </li>
          </ul>
          ...
          <div class="bg-gray-700 rounded p-4 mb-6 font-mono">
            ...
            <p class="text-slate-50 indent">
              ...
              { name: 'Mario', score: 100 }, { name: 'Luigi', score: 50 }, {
              name: 'Peach', score: 150 }, { name: 'Yoshi', score: 20 } ]
            </p>
            <p><span class="pr-6 text-slate-400">6</span>&nbsp;</p>
            <p class="text-slate-50 indent">
          ...
          <div class="bg-gray-700 rounded p-4 mb-6 font-mono">
            ...
            <p class="text-slate-50 indent">
              <span class="pr-6 text-slate-400">3</span>function
              addIdToValue&lt;T&gt;(val: T): T & HasID { const id =
              Math.random() return { ...val, id } }
            </p>
            <p><span class="pr-6 text-slate-400">4</span>&nbsp;</p>
            <p class="text-slate-50 indent">
              <span class="pr-6 text-slate-400">5</span>interface Post { title:
          ...
          <div class="bg-gray-700 rounded p-4 mb-6 font-mono">
            ...
            <p class="text-slate-50 indent">
              ...
              Collection&lt;string&gt; = { data: ['Mario', 'Luigi', 'Peach']
              name: 'Mario characters' }
            </p>
            <p class="text-slate-50 indent">
              <span class="pr-6 text-slate-400">4</span>const collectionTwo:
              Collection&lt;number&gt; = { data: [10, 15, 24, 33, 35, 3, 7]
      ...
      <div class="pb-10">
        <div class="pb-6">
          ...
          <div class="bg-gray-700 rounded p-4 mb-6 font-mono">
            <p class="text-slate-50 indent">
              <span class="pr-6 text-slate-400">1</span>function
              logUserEmails(users: Set&lt;User&gt;): void { users.forEach{
      ...
      <div class="pb-10">
        <div class="pb-6">
          ...
          <div class="bg-gray-700 rounded p-4 font-mono">
            <p class="text-slate-50 indent">
              <span class="pr-6 text-slate-400">1</span>enum Priority { Lowest =
              0 Medium = 1 High = 2 Urgent = 3 }
            </p>
            <p><span class="pr-6 text-slate-400">2</span>&nbsp;</p>
            <p class="text-slate-50 indent">
              <span class="pr-6 text-slate-400">3</span>function
            ...
            <p><span class="pr-6 text-slate-400">4</span>&nbsp;</p>
            <p class="text-slate-50 indent">
              <span class="pr-6 text-slate-400">5</span>addTicket('fix
              computer', Priority.Urgent)
              <span class="pl-2 text-green-400 italic"
