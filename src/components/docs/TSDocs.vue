    ...
    <div class="pb-6">
      ...
      <div class="bg-gray-700 rounded p-4 mb-6 font-mono relative pr-20">
        ...
        <p class="text-slate-50 indent">
          ...
          <span class="pl-2 text-green-400 italic">strict order of values</span>
        </p>
      </div>
      ...
      <div class="bg-gray-700 rounded p-4 mb-6 font-mono relative pr-20">
        ...
        <p class="text-slate-50 indent">
          <span class="pr-6 text-slate-400">2</span>hsla = [200, '100%', '50%',
          1]
          <span class="pl-2 text-green-400 italic"
  ...
  <div class="pb-10">
    <div class="pb-6">
      ...
      <ul class="pb-5 text-slate-800">
        ...
        <li>
          - Passing in an object literal that matches the interface type object
          directly into the function call
          <i>is allowed</i>
        </li>
        <li>
          - Passing in an object literal that includes and adds to the interface
          type object directly into the function call
          <i>is NOT allowed</i>
        </li>
        <li>
      ...
      <div class="bg-gray-700 rounded p-4 mb-6 font-mono relative pr-20">
        ...
        <p class="text-slate-50 indent">
          <span class="pr-6 text-slate-400">2</span>posts.push({title: 'Hello',
          body: 'Hello again'})
          <span class="pl-2 text-pink-400 italic">error</span>
        </p>
        <p><span class="pr-6 text-slate-400">3</span></p>
  ...
  <div class="pb-10">
    <div class="pb-6">
      ...
      <div class="bg-gray-700 rounded p-4 mb-6 font-mono relative pr-20">
        ...
        <p class="text-slate-50 indent">
          <span class="pr-6 text-slate-400">15</span>calcs.push(joinTwoNumbers)
          <span class="pl-2 text-pink-400 italic">error</span>
        </p>
        <p class="text-slate-50 indent">
          ...
          <span class="pl-2 text-green-400 italic"
            >None or one argument will still match the function signature</span
          >
        </p>
      </div>
  ...
  <div class="pb-10">
    <div class="pb-6">
      ...
      <div class="bg-gray-700 rounded p-4 mb-6 font-mono relative pr-20">
        ...
        <p class="text-slate-50 indent">
          <span class="pr-6 text-slate-400">7</span>const personTwo = { id: "2",
          firstName: "Luigi", email: "luigi@dev.com", };
        </p>
        <p class="text-slate-50 indent">
          <span class="pr-6 text-slate-400">8</span>const personThree = { email:
          "peach@dev.com", };
        </p>
        <p class="text-slate-50 indent">
        ...
        <p class="text-slate-50 indent">
          ...
          <span class="pl-2 text-green-400 italic">2 Luigi luigi@dev.com</span>
        </p>
        <p class="text-slate-50 indent">
    ...
    <div class="pb-6">
      ...
      <div class="bg-gray-700 rounded p-4 mb-6 font-mono relative pr-20">
        ...
        <p class="text-slate-50 indent">
          ...
          <span class="pl-2 text-green-400 italic">72835 Hello, Mario 250</span>
        </p>
      </div>
